  ...
  return (
    <Flex maxW="6xl" mx="auto" py={10} gap={10} px={4}>
      ...
      <Box w="40%" p={5} borderRadius="md" mt="50px">
        ...
        <Box mb={8}>
          <Text fontSize="xl" fontWeight="bold" mb={4} color="#26241C">Contact Info</Text>
          <Text fontSize="md" mb={1} color="#4F4B3B">+92 319 6780744</Text>
          <Text fontSize="md" color="#4F4B3B">info@wehring.fd</Text>
        </Box>
        ...
        <Box mb={8} color="#4F4B3B">
          <Text fontSize="xl" fontWeight="bold" mb={4} color="#26241C">Visit our office</Text>
        ...
        <Flex>
          <FontAwesomeIcon icon={faFacebook} style={{ color: "#FED904",h:"20px",w:"20px"}} />
          <Text fontSize="md" fontWeight="bold" ml="10px" color="#5E5D5D" >Facebook</Text>
        </Flex>

        <Flex>
          <FontAwesomeIcon icon={faInstagram} style={{ color: "#FED904",h:"20px",w:"20px"}} />
          <Text fontSize="md" fontWeight="bold" ml="10px" color="#5E5D5D">Instagram</Text>
        </Flex>

        <Flex>
          <FontAwesomeIcon icon={faLinkedin}  style={{ color: "#FED904",h:"20px",w:"20px"}} />
          <Text fontSize="14px" fontWeight="bold" ml="10px" color="#5E5D5D">linkedin</Text>
        </Flex>
      </Box>
      ...
      <Container 
        ...
        bg="#F8F8F6"
      >
        <Text fontSize="16px" fontWeight="700" color="#FED904" letterSpacing="5px">CONTACT</Text>
        <Text fontSize="35px" fontWeight="700" mt={2}>Let's get in touch</Text>
        <Text fontSize="15px" color="gray.600" mt={1} fontWeight="400">
          You can reach us anytime via <Text as="span" color="#FED904">info@wehring.fd</Text>
        </Text>
