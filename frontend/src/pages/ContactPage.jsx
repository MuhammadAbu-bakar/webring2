import {
  ...
  function App() {
    ...
    return (
      <Box width={"1920px"} padding={0} margin={0}>
        ...
        <Box width="100%" padding="100px">
            <Container maxW="1920px" display="flex" flexWrap="wrap" justifyContent="center" gap="24px">
              {contactCards.map((card) => (
                ...
                >
                  <Image src={card.image} width="44px" height="44px" mt="40px" ml={"35px"}/>
        ...
        {/* Form Box */}
        <Box width="100%" height="989px" position="absolute">
          <Image src="/Rectangle 39.png" width="847px" height="891px" zIndex={1} position="absolute" />
   
          <Box width="100%" height="842px" position="absolute" top="147px"  display="flex" bgColor="#14140F" justifyContent="center" alignItems="center">
            <Container top={"110px"} left={"972px"} position="absolute" zIndex={2} width="636px" height="659px">
              <Container width={"606px"} height={"184px"} gap={"29px"} padding={"0"} margin={"0"}>  
              ...
              {/* Contact Form */}
              <Box width={"100%"} height={"331px"}  gap="35px" marginY="70px">
