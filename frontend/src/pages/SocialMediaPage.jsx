    ...
    <>
      ...
      <Box width="100%" bg="black" gap={10}>
        ...
        >
          ...
          >
            ...
            <Stack spacing={{ base: 3, md: 4, xl: 5 }} fontSize={{ base: "16px", md: "18px", xl: "20px" }} color="gray.300">
              <Text>
              Harness the power of Digital Marketing & Social Media Marketing for service business through our Marketing Digital Agency to amplify your brand’s reach and engagement. Our Digital Marketing & Social Media Marketing services strategic approach ensures tailored, memorable ad campaigns across various platforms, driving traffic, building a loyal community, and boosting conversions.
              </Text>
              <Text>
              Let us transform your marketing & social media presence into a dynamic, impactful, and revenue-generating asset. Let’s collaborate!
              </Text>
            </Stack>
        ...
        >
          ...
          Amplifying brands through creating ad campaigns, engaging SEO oriented content, and data-driven unique strategies for impactful online connections.								</Text>
          <Flex
            width="100%"
