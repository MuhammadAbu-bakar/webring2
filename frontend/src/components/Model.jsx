import { Box, Flex, Text, Image, useBreakpointValue, Center } from "@chakra-ui/react";
...
const OurModelSection = () => {
  ...
  return (
    <Flex
      ...
      gap={"5%"}
    >
      <Box textAlign={{base: "center", md: "center", lg: "left", xl: "left"}} mb={10} alignSelf="flex-start" width={{ base: "100%", md: "100%", lg: "20%", xl: "25%" }}>
        ...
        <Text fontSize={{ base: "16px", md: "18px", xl: "22px" }} fontWeight="400" opacity="0.8" color="#F8F8F6" pt={4}>
      ...
      {isMobile ? (
        ...
        {steps.map((step, index) => (
          <Flex
            key={index}
            w={{ base: "90%", md: "65%" }} // Responsive width
            h="70px"
            bg="white"
            borderRadius="10px"
            alignItems="center"
          ...
          >
            ...
            {/* Circle Display for Steps 2 to 6 */}
            {index > 0 && (
              <Box
                width="18px"
                height="18px"
        ...
        {/* Dashed Line for Connecting Steps */}
        <Box
          position="absolute"
          width="2px"
          height="100%"
        ...
        {steps.map((step, index) => (
          ...
          >
            ...
            <Flex w={{ base: "90%", md: "25px", lg: "70px", "2xl": "50px" }} h={{ base: "90%", md: "35px", lg: "40px", xl: "40px", "2xl": "50px" }} bg="#FFFBE6" borderRadius="10px" alignItems="center" justifyContent="center" mr="20px">
              <Image src={step.icon} alt={step.title} w="40px" h="30px" />
            </Flex>
            <Text fontSize={{ lg: "12px", xl :"14px", "2xl": "16px"}} fontWeight="500" color="#26241C">{step.title}</Text>
