import { Box,Flex, Grid, Text, VStack, HStack, Image, useBreakpointValue } from "@chakra-ui/react";
...
const ServicesSection = () => {
  ...
  return (
    <Box maxW="1920px" w="100%" m="auto" px={{ base: "20px", md: "50px", xl: "100px" }} py={{ base: "30px", md: "50px" }}>
    <VStack spacing={{ base: "40px", md: "80px" }} align="flex-start" w="full">
      <Flex
      ...
      >
        ...
        <Text
          ...
          w={{ base: "100%", md: "698px" }}
        >
          One fundamental aspect of IT services is infrastructure management. This involves the design, implementation,
          and maintenance of the hardware, software, networks, and servers.
        </Text>
      </Flex>

      <Grid templateColumns={gridTemplateColumns} gap={{ base: "20px", md: "29px" }} w="full" mt={{ base: "40px", md: "100px" }}>
